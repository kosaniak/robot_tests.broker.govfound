...
Отримати посилання на аукціон для глядача
    ...
    govfound.Пошук Тендера По Ідентифікатору  ${viewer}  ${tender_uaid}
...
Завантажити протокол скасування в контракт
    [Arguments]  ${username}  ${tender_uaid}  ${file_path}  ${award_index}
    govfound.Завантажити протокол дискваліфікації в авард  ${username}  ${tender_uaid}  ${file_path}  ${award_index}
